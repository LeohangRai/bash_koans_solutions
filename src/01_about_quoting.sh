...
ple
    # backslash (\) is used as an escape character for line continuation, meaning the next line after the backslash will be considered as part of the same command or statement
